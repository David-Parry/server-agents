package com.davidparry.agent.client.reliability;
...
public class ReconnectionManager {
    ...
    private final AgentClientProperties.ReconnectConfig config;
    private final AtomicInteger attemptCount = new AtomicInteger(0);
    private final AtomicReference<Instant> lastAttemptTime = new AtomicReference<>();
    
    public ReconnectionManager(AgentClientProperties properties) {
