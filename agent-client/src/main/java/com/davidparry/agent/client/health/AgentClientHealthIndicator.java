package com.davidparry.agent.client.health;

import com.davidparry.agent.client.mcp.McpServerManager;
import com.davidparry.agent.client.websocket.ConnectionState;
...
@Component
public class AgentClientHealthIndicator implements HealthIndicator {
    
    private final WebSocketClientHandler webSocketHandler;
    private final McpServerManager mcpServerManager;
    
    public AgentClientHealthIndicator(
