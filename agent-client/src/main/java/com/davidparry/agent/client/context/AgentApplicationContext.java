...
import com.davidparry.agent.client.agent.AgentConfigLoader;
import com.davidparry.agent.client.config.AgentClientProperties;
import com.davidparry.agent.client.mcp.McpServerManager;
import com.davidparry.agent.client.mcp.SessionMcpManager;
import com.davidparry.agent.client.websocket.WebSocketClientHandler;
...
public class AgentApplicationContext {
     ...
     */
    public AgentApplicationContext(AgentClientProperties properties, ObjectMapper objectMapper,
    ...
    private void loadAgentConfigurations() {
        ...
        try {
            if (configPath != null && !configPath.isBlank()) {
                ...
                String defaultPath = AgentClientProperties.DEFAULT_AGENT_CONFIG;
