...
public class WebSocketClientHandler extends TextWebSocketHandler {
    ...
    public WebSocketClientHandler(AgentClientProperties properties, ObjectMapper objectMapper,
